...
const UserInterface: React.FC<UserInterfaceProps> = ({ backendName }) => {
  ...
  return (
    <div className={`user-interface ${bgColor} ${backendName} w-full p-4`}>
      {/* Header */}
      <div className="flex items-center justify-center mb-8">
        <img src="/logo.svg" alt="Logo" className="w-20 h-20 mr-2" />
        <h1 className="text-white flex items-center text-xl font-bold">
          <span className="text-6xl">PostOxideDB</span>
        </h1>
      </div>
      ...
      <form
        onSubmit={createUser}
        className="mt-8 p-4 bg-blue-100 rounded shadow"
      >
        <input
          placeholder="Name"
          value={newUser.name}
